<template>
	<view>
		<view class="uni-page-head">
			...
			<view class="text">
				本次提供帮助金额仅作为入场凭证，没有利息收入，完成打款后即可获得入场资格。
			</view>
		</view>
		...
		<view class="uni-padding-wrap">
			...
			<view class="btn-box">
				<button type="primary" @tap="submit">买入聚德</button>
			</view>
		</view>
	</view>
	</view>
...
<script>
	...
	import {prepaySave,getParam} from '@/common/getData'
	...
	export default {
		...
		methods: {
			...
			submit() {
				...
				uni.showModal({
					content:`本次订单帮助金额￥${data.amount}仅作为入场凭证，没有利息收入，请确定是否继续？`,
					confirmColor:"#E5BC2D",
					success:e=>{
						if(e.confirm){
							this.toSubmit(data);
